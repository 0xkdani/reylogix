...
/**
 * Bloque de features en retícula de 6 columnas.
 *
 * Tres adaptaciones respecto al snippet original, todas anotadas en su sitio:
 *  1. Dos clases venían en sintaxis de Tailwind v4 —`rounded-tl-(--radius)` y
 *     `before:bg-(--color-border)`— que en v3 no generan nada y quedaban muertas.
 *  2. Los títulos de tarjeta eran <h2>. La página ya tiene un <h2> (el de
 *     SectionHeader), así que aquí bajan a <h3> para no romper la jerarquía.
 *  3. La copy de relleno se cambió por el contenido real de Enfoque, y los
            ...
            <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
              <CardContent className="relative m-auto size-fit pt-6">
                <div className="relative flex h-24 w-56 items-center">
                  ...
                  <span className="mx-auto block w-fit text-5xl font-semibold">3</span>
                </div>
                <h3 className="mt-6 text-center text-3xl font-semibold">Metodologías</h3>
              </CardContent>
            </Card>
              ...
              <CardContent className="pt-6">
                ...
                <div className="relative z-10 mt-6 space-y-2 text-center">
                  ...
                  <p className="text-muted-foreground">
                    Cada minuto, cada documento y cada decisión impacta en costos, cumplimiento y
                    reputación.
                  </p>
                </div>
              </CardContent>
            ...
            <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
              <CardContent className="pt-6">
                ...
                <div className="relative z-10 mt-14 space-y-2 text-center">
                  <h3 className="text-lg font-medium transition">Rendimiento operativo</h3>
                  <p className="text-muted-foreground">
                    Optimizar cadenas de suministro, reducir fricción y acelerar el rendimiento
                    operativo.
                  </p>
                </div>
              </CardContent>
              ...
              <CardContent className="grid pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground">
                      Desde auditorías de costos hasta rediseños operativos, intervenimos con
                      lógica, método y claridad.
                    </p>
                  </div>
                </div>
                {/* `rounded-tl-(--radius)` es sintaxis de Tailwind v4 y aquí no
                    generaba nada: en v3 el valor arbitrario va entre corchetes. */}
            ...
            <Card className="relative col-span-full overflow-hidden lg:col-span-3">
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    <h3 className="text-lg font-medium transition">Entornos complejos</h3>
                    <p className="text-muted-foreground">
                      Trabajamos con empresas que operan en entornos complejos, con visión
                      internacional.
                    </p>
                  </div>
                </div>
                {/* `before:bg-(--color-border)` también era sintaxis v4. Aquí se
                    usa el token `border` del propio tema, que es lo que nombraba. */}
                  ...
                  <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      ...
                      <div className="ring-background size-7 ring-4">
                        <img className="size-full rounded-full object-cover" src={PEOPLE[0].avatar} alt="" />
                      </div>
                    </div>
                    <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                      <div className="ring-background size-8 ring-4">
                        <img className="size-full rounded-full object-cover" src={PEOPLE[1].avatar} alt="" />
                      </div>
                      <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">
                        {PEOPLE[1].label}
                      </span>
                    ...
                    <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                      ...
                      <div className="ring-background size-7 ring-4">
                        <img className="size-full rounded-full object-cover" src={PEOPLE[2].avatar} alt="" />
                      </div>
                    </div>
                  </div>
                </div>
